package com.example.task_practice.utils;
...
public class AppUtil {
    ...
    static {
        ...
        public static LocalDateTime convertStringToCurrentDateTime(String timeString) {
            LocalTime time = LocalTime.parse(timeString);
            LocalDateTime currentDateTime = LocalDateTime.of(LocalDateTime.now().toLocalDate(), time);
